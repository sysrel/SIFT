...
namespace klee {
  ...
  public:
    ...
    virtual void stashState(ExecutionState *s) {};
    virtual void unstashState(ExecutionState *s) {};
  ...
  public:
    ...
    void stashState(ExecutionState *s); 
    void unstashState(ExecutionState *s);
  ...
  public:
    ...
    void printName(llvm::raw_ostream &os) {
      ...
      case CustomWeight       : os << "CustomeWight\n"; return;
